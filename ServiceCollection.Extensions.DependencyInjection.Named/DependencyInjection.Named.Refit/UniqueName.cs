...
namespace DependencyInjection.Named.Refit
{
    public class UniqueName
    {
        public static string ForTypeNamed<T>(string name)
        {
            return ForType(typeof(T), name);
        }

        public static string ForType(Type refitInterfaceType, string name)
        {
            ...
            var assmQualified = $"{refitTypeName}, {refitInterfaceType.Assembly.FullName}, {name}";
